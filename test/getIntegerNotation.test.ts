...
Deno.test("return the correct integer notation for natural notes", () => {
...
Deno.test(
  "return the correct integer notation for sharp notes using '#'",
  () => {
...
Deno.test(
  "return the correct integer notation for flat notes using 'b'",
  () => {
...
Deno.test(
  "return the correct integer notation for flat notes using '♭'",
  () => {
...
Deno.test("handle double sharps and flats (if included in data)", () => {
...
Deno.test("return undefined for invalid note names", () => {
