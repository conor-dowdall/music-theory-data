 ...
 */
export type DominantVariantName =
  | "dominant7"
  | "dominant9"
  | "dominant11"
  | "dominant13";
 ...
 * @see {@link DominantVariantName} for the name of each variant.
 * @see {@link NoteSequenceTheme} for the structure of each variant.
 */
export const dominantVariants: Record<DominantVariantName, NoteSequenceTheme> =
  {
    dominant7: {
      primaryName: "7",
