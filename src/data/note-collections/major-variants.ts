...
const major6: ChordCollection = {
  ...
  symbol: { chordSuffix: "6", romanSuffix: "6", numeralCase: "upper" },
  intervals: ["1", "3", "5", "6"],
  integers: [0, 4, 7, 9],
...
const major9: ChordCollection = {
  ...
  symbol: { chordSuffix: "M9", romanSuffix: "M9", numeralCase: "upper" },
  intervals: ["1", "3", "5", "7", "9"],
...
const majorAdd9: ChordCollection = {
  ...
  symbol: { chordSuffix: "add9", romanSuffix: "add9", numeralCase: "upper" },
  intervals: ["1", "3", "5", "9"],
  integers: [0, 4, 7, 14],
  type: ["major", "chord", "arpeggio", "tetrad"],
  characteristics: [
...
const major6Add9: ChordCollection = {
  ...
  symbol: { chordSuffix: "6/9", romanSuffix: "6/9", numeralCase: "upper" },
  intervals: ["1", "3", "5", "6", "9"],
  integers: [0, 4, 7, 9, 14],
  type: ["major", "chord", "arpeggio", "pentad"],
  characteristics: [
