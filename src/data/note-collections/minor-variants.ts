...
const minor: ChordCollection = {
  ...
  symbol: { chordSuffix: "m", romanSuffix: "", numeralCase: "lower" },
  intervals: ["1", "♭3", "5"],
  integers: [0, 3, 7],
...
const minor6: ChordCollection = {
  ...
  symbol: { chordSuffix: "m6", romanSuffix: "m6", numeralCase: "lower" },
  intervals: ["1", "♭3", "5", "6"],
  integers: [0, 3, 7, 9],
...
const minor7: ChordCollection = {
  ...
  symbol: { chordSuffix: "m7", romanSuffix: "m7", numeralCase: "lower" },
  intervals: ["1", "♭3", "5", "♭7"],
  integers: [0, 3, 7, 10],
  type: ["minor", "chord", "arpeggio", "tetrad"],
...
const minorMajor7: ChordCollection = {
  ...
  symbol: { chordSuffix: "m(M7)", romanSuffix: "M7", numeralCase: "lower" },
  intervals: ["1", "♭3", "5", "7"],
  integers: [0, 3, 7, 11],
  type: ["minor", "chord", "arpeggio", "tetrad"],
...
const minor9: ChordCollection = {
  ...
  symbol: { chordSuffix: "m9", romanSuffix: "m9", numeralCase: "lower" },
  intervals: ["1", "♭3", "5", "♭7", "9"],
...
const minor6Add9: ChordCollection = {
  ...
  symbol: { chordSuffix: "m6/9", romanSuffix: "m6/9", numeralCase: "lower" },
  intervals: ["1", "♭3", "5", "6", "9"],
  integers: [0, 3, 7, 9, 14],
  type: ["minor", "chord", "arpeggio", "pentad"],
  characteristics: [
